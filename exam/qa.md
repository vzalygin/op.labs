...
Данный markdown-файлик содержит в себе разбор вопросов для экзамена по дисциплине "Основы программирования" кафедры ИУ6 потока 2022. Фактически это краткая выжимка теории со всего курса. Я расписал те факты, которые считаю важными + дополнил своими замечаниями и комментариями, описал пару важных моментов, которые были пропущены во время чтения курса.
