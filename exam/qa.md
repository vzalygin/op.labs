...
Данный markdown-файлик содержит в себе разбор вопросов для экзамена по дисциплине "Основы программирования" кафедры ИУ6 потока 2022. Фактически это краткая выжимка теории со всего курса. Я расписал те факты, которые считаю важными (моё мнение может отличаться от общепринятого) + дополнил своими замечаниями и комментариями, раскрыл важные моменты, которые были пропущены во время чтения курса.
