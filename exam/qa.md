...
[Смотреть тут](https://github.com/pluttan/BMSTU-1/)
...
Поскольку я не вижу смысла глубоко разбирать этот вопрос, из-за его не совсем понятного статуса (а что это вообще делает в курсе по основам программирования?), я стащу разбор этого билета у более [ответственных людей](https://github.com/pluttan/BMSTU-1/)).
